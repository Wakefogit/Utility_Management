...
const CompressedAirTariff = () => {
  const dispatch = useDispatch();

  useEffect(() => {
    dispatch(setPageTitle({ title: "Compressed Air Tariff" }));
  }, []);
  ...
  return (
    <>
      ...
      <div>
        <label className="block mb-2 mt-8 text-xl font-medium text-gray-900 dark:text-white ">
            ...
            >
              <Box sx={style}>
                ...
                <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                  Enter the value of your monthly fees for compressed air. If you
                  aren't sure about it, check the costs in your last compressed air
                  invoice or in the pricelist of your compressed air retailer.
                </Typography>
              </Box>
            </Modal>
          </div>
          ...
          <div>
            ...
            >
              <Box sx={style}>
                ...
                <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                  Enter the value of your cost for compressed air consumed in basic
                  tariff rate. If you aren't sure about it, check the costs in
                  your last compressed air invoice or in pricelist of your
                  compressed air retailer.
                </Typography>
              </Box>
            </Modal>
          </div>
          ...
          <div>
            ...
            >
              <Box sx={style}>
                ...
                <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                  Enter the value of your cost for compressed air consumed in low
                  tariff rate. If you aren't sure about it, check the costs in
                  your last compressed air invoice or in pricelist of your
                  compressed air retailer.
                </Typography>
...
export default CompressedAirTariff;
