          ...
          <li className="flex ">
            <ul className="grid col-span-2">
              <div date-rangepicker class="flex items-left">
                ...
                <span className="mx-4 my-2 text-black-500">to</span>
            ...
            <ul>
              <button>
                <a
                  href="#_"
                  className="relative mt-1 mx-4 my-3 pb-1 inline-flex items-center justify-center pl-3 px-3 py-2 overflow-hidden font-medium text-black-600 transition duration-300 ease-out border-2 border-transparent rounded-md shadow-md group"
                >
                  <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-blue-700 group-hover:translate-x-0 ease float-right">
                    <svg
                      className="w-4 h-4"
                  ...
                  <div className="absolute  flex items-center justify-center w-full h-full text-blue-700 transition-all duration-300 transform group-hover:translate-x-full ease">
                    GO
                  </div>
            ...
            <ul>
              <div className="mx-4 my-3 mt-1 pb-1  max-w-full hover:bg-gradient-to-r grid col-span-2 float-right ml-10">
                <label htmlFor="parameters" className="sr-only">
                  Exports
                </label>
